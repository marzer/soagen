...
namespace soagen::examples
{
                           ...
                           public soagen::mixins::swappable<entities>)
    {
      ...
      public:
        ...
        SOAGEN_CONSTEXPR_20 //
        SOAGEN_ENABLE_IF_T(entities&, sfinae)
        erase(size_type pos)                                                      //
      ...
      public:
        ...
        SOAGEN_CONSTEXPR_20
        SOAGEN_ENABLE_IF_T(entities&, sfinae)
        emplace(size_type index_, Id&& id, Name&& name = "", Pos&& pos = {}, Orient&& orient = { 1, 0, 0, 0 }) //
        ...
        SOAGEN_CONSTEXPR_20
        SOAGEN_ENABLE_IF_T(iterator, sfinae)
        emplace(iterator iter_, Id&& id, Name&& name = "", Pos&& pos = {}, Orient&& orient = { 1, 0, 0, 0 }) //
            noexcept(table_traits::emplace_is_nothrow<table_type, Id&&, Name&&, Pos&&, Orient&&>)            //
        {
            table_.emplace(static_cast<size_type>(iter_),
                           static_cast<Id&&>(id),
        ...
        SOAGEN_CONSTEXPR_20
        SOAGEN_ENABLE_IF_T(const_iterator, sfinae)
        emplace(const_iterator iter_, Id&& id, Name&& name = "", Pos&& pos = {}, Orient&& orient = { 1, 0, 0, 0 }) //
            noexcept(table_traits::emplace_is_nothrow<table_type, Id&&, Name&&, Pos&&, Orient&&>)                  //
        {
            table_.emplace(static_cast<size_type>(iter_),
                           static_cast<Id&&>(id),
        ...
        template <auto... Cols>
        constexpr soagen::iterator_type<entities, Cols...> begin() & noexcept;

        /// @brief Returns an iterator to one-past-the-last row in the table.
        template <auto... Cols>
        constexpr soagen::iterator_type<entities, Cols...> end() & noexcept;
        ...
        /// @brief Returns an iterator to the first row in the table.
        template <auto... Cols>
        constexpr soagen::const_iterator_type<entities, Cols...> begin() const& noexcept;

        /// @brief Returns an iterator to one-past-the-last row in the table.
        template <auto... Cols>
        constexpr soagen::const_iterator_type<entities, Cols...> end() const& noexcept;

        /// @brief Returns an iterator to the first row in the table.
        template <auto... Cols>
        constexpr soagen::const_iterator_type<entities, Cols...> cbegin() const noexcept;

        /// @brief Returns an iterator to one-past-the-last row in the table.
        template <auto... Cols>
        constexpr soagen::const_iterator_type<entities, Cols...> cend() const noexcept;
        ...
        template <auto... Cols>
        soagen::row_type<entities, Cols...> row(size_type index) & noexcept;
        ...
        template <auto... Cols>
        soagen::row_type<entities, Cols...> at(size_type index) &;

        /// @brief Returns the very first row in the table.
        template <auto... Cols>
        soagen::row_type<entities, Cols...> front() & noexcept;

        /// @brief Returns the very last row in the table.
        template <auto... Cols>
        soagen::row_type<entities, Cols...> back() & noexcept;
        ...
        /// @tparam Cols Indices of the columns to include in the row. Leave the list empty for all columns.
        template <auto... Cols>
        soagen::const_row_type<entities, Cols...> row(size_type index) const& noexcept;
        ...
        /// @note This function is not available when exceptions are disabled.
        template <auto... Cols>
        soagen::const_row_type<entities, Cols...> at(size_type index) const&;

        /// @brief Returns the very first row in the table.
        template <auto... Cols>
        soagen::const_row_type<entities, Cols...> front() const& noexcept;

        /// @brief Returns the very last row in the table.
        template <auto... Cols>
        soagen::const_row_type<entities, Cols...> back() const& noexcept;
    ...
    SOAGEN_HIDDEN_CONSTRAINT(sfinae, auto sfinae = soagen::detail::has_swap_member<entities>::value)
    SOAGEN_ALWAYS_INLINE
    constexpr void swap(entities& lhs, entities& rhs) //
        noexcept(soagen::detail::has_nothrow_swap_member<entities>::value)
    {
        lhs.swap(rhs);
    }
