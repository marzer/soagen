...
namespace soagen::examples
{
    ...
    SOAGEN_HIDDEN_CONSTRAINT(sfinae, auto sfinae = soagen::detail::has_swap_member<boxes>::value)
    SOAGEN_ALWAYS_INLINE
    constexpr void swap(boxes& lhs, boxes& rhs) //
        noexcept(soagen::detail::has_nothrow_swap_member<boxes>::value)
    {
        lhs.swap(rhs);
    }
...
namespace soagen::examples
{
    ...
    /// is swappable or non-propagating.
    SOAGEN_HIDDEN_CONSTRAINT(sfinae, auto sfinae = soagen::detail::has_swap_member<spheres>::value)
    SOAGEN_ALWAYS_INLINE
    constexpr void swap(spheres& lhs, spheres& rhs) //
        noexcept(soagen::detail::has_nothrow_swap_member<spheres>::value)
    {
        lhs.swap(rhs);
    }
