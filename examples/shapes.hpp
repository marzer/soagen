						   ...
						   public soagen::mixins::swappable<boxes>)
	{
	  ...
	  public:
			...
			noexcept(table_traits::for_each_column_nothrow_invocable<Func&&>)
		{
			...
			soagen::invoke_with_optional_index<4>(static_cast<Func&&>(func), this->template column<4>());
			soagen::invoke_with_optional_index<5>(static_cast<Func&&>(func), this->template column<5>());
			soagen::invoke_with_optional_index<6>(static_cast<Func&&>(func), this->template column<6>());
		}
