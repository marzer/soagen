	  ...
	  public:
		...
		template <typename CenterX,
				  ...
				  typename Mass		= column_traits<6>::default_emplace_type SOAGEN_ENABLE_IF(
					  table_traits::row_constructible_from<CenterX&&,
														   CenterY&&,
														   CenterZ&&,
														   ExtentsX&&,
														   ExtentsY&&,
		...
		boxes& emplace_back(CenterX&& center_x,
			...
			noexcept(table_traits::emplace_back_is_nothrow<table_type&,
														   ...
														   ExtentsZ&&,
														   Mass&&>)
				SOAGEN_REQUIRES(table_traits::row_constructible_from<CenterX&&,
																	 CenterY&&,
																	 CenterZ&&,
																	 ExtentsX&&,
																	 ExtentsY&&,
				  ...
				  typename Mass		= column_traits<6>::default_emplace_type SOAGEN_ENABLE_IF(
					  (table_traits::all_move_constructible && table_traits::all_move_assignable
					   && table_traits::row_constructible_from<CenterX&&,
															   ...
															   Mass&&>))>
		SOAGEN_CPP20_CONSTEXPR
		boxes& emplace(size_type index_,
					   CenterX&& center_x,
					   CenterY&& center_y,
					   CenterZ&& center_z,
					   ExtentsX&& extents_x = 0.5,
				  ...
				  typename Mass		= column_traits<6>::default_emplace_type SOAGEN_ENABLE_IF(
					  (table_traits::all_move_constructible && table_traits::all_move_assignable
					   && table_traits::row_constructible_from<CenterX&&,
															   ...
															   Mass&&>))>
		SOAGEN_CPP20_CONSTEXPR
		iterator emplace(iterator iter_,
						 CenterX&& center_x,
						 CenterY&& center_y,
						 CenterZ&& center_z,
						 ExtentsX&& extents_x = 0.5,
		...
		/// @brief Returns an iterator to the first row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<boxes, Columns...> begin() const& noexcept;

		/// @brief Returns an iterator to one-past-the-last row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<boxes, Columns...> end() const& noexcept;

		/// @brief Returns an iterator to the first row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<boxes, Columns...> cbegin() const noexcept;

		/// @brief Returns an iterator to one-past-the-last row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<boxes, Columns...> cend() const noexcept;
						   ...
						   public soagen::mixins::swappable<spheres>)
	{
	  ...
	  public:
		...
		template <typename CenterX,
				  ...
				  typename Mass	  = column_traits<4>::default_emplace_type SOAGEN_ENABLE_IF(
		...
		template <typename CenterX,
				  ...
				  typename Mass	  = column_traits<4>::default_emplace_type SOAGEN_ENABLE_IF(
						(table_traits::all_move_constructible && table_traits::all_move_assignable
						 && table_traits::row_constructible_from<CenterX&&, CenterY&&, CenterZ&&, Radius&&, Mass&&>))>
		SOAGEN_CPP20_CONSTEXPR
		spheres& emplace(size_type index_,
						 CenterX&& center_x,
						 CenterY&& center_y,
						 CenterZ&& center_z,
						 Radius&& radius = 0.5,
		...
		template <typename Tuple SOAGEN_ENABLE_IF(
			(table_traits::row_constructible_from<Tuple&&> && table_traits::all_move_constructible
			 && table_traits::all_move_assignable && table_traits::row_constructible_from<size_type, Tuple&&>))>
		SOAGEN_CPP20_CONSTEXPR
		spheres& emplace(size_type index_, Tuple&& tuple_) //
			noexcept(table_traits::emplace_is_nothrow<table_type&, Tuple&&>) SOAGEN_REQUIRES(
				table_traits::row_constructible_from<Tuple&&>&& table_traits::all_move_constructible&&
					table_traits::all_move_assignable&& table_traits::row_constructible_from<size_type, Tuple&&>) //
		{
		...
		/// @brief Returns an iterator to the first row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<spheres, Columns...> begin() const& noexcept;

		/// @brief Returns an iterator to one-past-the-last row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<spheres, Columns...> end() const& noexcept;

		/// @brief Returns an iterator to the first row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<spheres, Columns...> cbegin() const noexcept;

		/// @brief Returns an iterator to one-past-the-last row in the table.
		template <auto... Columns>
		constexpr soagen::const_iterator_type<spheres, Columns...> cend() const noexcept;
