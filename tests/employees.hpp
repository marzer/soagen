...
namespace soagen::detail
{
	...
	struct table_traits_type_<tests::employees>
	{
		using type = table_traits<
			/*			name */ make_column<const std::string>,
			/*			  id */ make_column<unsigned long long, param_type<unsigned long long>, 32>,
			/* date_of_birth */ make_column<std::tuple<int, int, int>>,
...
namespace tests
{
		  ...
		  public soagen::mixins::swappable<employees>
	{
	  public:
		...
		template <size_type Column>
		static constexpr auto& column_name = soagen::detail::col_name_<employees, Column>::value;
