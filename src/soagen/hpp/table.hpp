...
namespace soagen
{
                           ...
                           public mixins::iterators<table<Traits, Allocator>>)
    {
      ...
      public:
        ...
        /// @brief Resizes the table, leaving any new elements uninitialized rather than value-initialized.
        ///
        /// @details New elements of trivially-constructible columns are left with indeterminate values (ready to be
        ///          overwritten, e.g. when deserializing); non-trivially-constructible columns are default-constructed.
        ///
        /// @availability This method is only available when all the column types are default-constructible.
        void resize_for_overwrite(size_type new_size) noexcept(...);
