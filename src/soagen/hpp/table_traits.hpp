...
namespace soagen
{
                                                                        ...
                                                                        detail::as_column<Columns>...>)
    {
        ...
        static constexpr bool emplace_back_is_nothrow =
            POXY_IMPLEMENTATION_DETAIL(detail::has_nothrow_emplace_back_member<BackingTable, Args...>::value);
        ...
        static constexpr bool emplace_is_nothrow =
            POXY_IMPLEMENTATION_DETAIL(detail::has_nothrow_emplace_member<BackingTable, std::size_t, Args...>::value);
