...
namespace soagen
{
        ...
        SOAGEN_HIDDEN_BASE(public detail::column_traits_base<storage_type<ValueType>>)
    {
        ...
        using param_forward_type = POXY_IMPLEMENTATION_DETAIL(detail::forward_type<param_type>);
        ...
        using rvalue_forward_type = POXY_IMPLEMENTATION_DETAIL(detail::forward_type<rvalue_type>);
